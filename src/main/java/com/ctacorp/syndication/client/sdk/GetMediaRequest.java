...
public class GetMediaRequest {
    ...
    Date contentAuthored;
    Date contentUpdated;
    Date contentPublished;
    Date contentReviewed;
    Date syndicationCaptured;
    Date syndicationUpdated;
    Date contentAuthoredSinceDate;
    Date contentAuthoredBeforeDate;
    String contentAuthoredInRange;
    Date contentUpdatedSinceDate;
    Date contentUpdatedBeforeDate;
    String contentUpdatedInRange;
    Date contentPublishedSinceDate;
    Date contentPublishedBeforeDate;
    String contentPublishedInRange;
    Date contentReviewedSinceDate;
    Date contentReviewedBeforeDate;
    String contentReviewedInRange;
    Date syndicationCapturedSinceDate;
    Date syndicationCapturedBeforeDate;
    String syndicationCapturedInRange;
    Date syndicationUpdatedSinceDate;
    Date syndicationUpdatedBeforeDate;
    String syndicationUpdatedInRange;
    Date syndicationVisibleSinceDate;
    Date syndicationVisibleBeforeDate;
    String syndicationVisibleInRange;
    Long languageId;
    String languageName;
    ...
    String sourceAcronymContains;
    String tagIds;
    String restrictToSet;
